...
- `configuration/` — sublevel with detailed conventions for static and runtime configuration component forms.
...
4. `configuration/AGENTS.md` — defines reading order for detailed static/runtime configuration conventions.
5. `es6-modules.md` — defines how components are published through ES modules and instantiated by the container.
6. `types-map.md` — defines the static bridge between namespace identifiers and implementation modules used by IDE tooling.
7. `jsdoc.md` — defines deterministic annotation rules that apply namespace-based types in runtime JavaScript.
